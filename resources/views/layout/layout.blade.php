...
<head>
    ...
    <title>Sikat BPS Provinsi Sumatera Selatan</title>
        ...
        <div class="container py-13 py-md-15">
            <div class="row gy-6 gy-lg-0">
                <div class="col-md-4 col-lg-3">
                    <div class="widget">
                        <img class="mb-4" src="./assets/img/logo-light.png" srcset="./assets/img/logo-light.png 2x"
                            alt="" />
                        <p class="mb-4">© 2020 Sikat. <br class="d-none d-lg-block" />All rights reserved.</p>
                ...
                <div class="col-md-4 col-lg-3">
                    <div class="widget">
                        ...
                        <address class="pe-xl-15 pe-xxl-17">Palembang, Sumatera Selatan
                        </address>
                        <a href="mailto:#">bps1600@bps.go.id</a><br /> 0813-3378-3485
                    </div>
                    <!-- /.widget -->
                </div>
                <!-- /column -->
                                ...
                                <form id="mc-embedded-subscribe-form2" name="mc-embedded-subscribe-form"
                                    ...
                                    <div id="mc_embed_signup_scroll2">
                                        <div class="mc-field-group input-group form-floating">
                                            ...
                                            <input type="button" value="Join" name="subscribe"
